            ...
            return Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text('Why Japan?', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      Text('Japan Scholarships', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))
                    ],
                  ),
                  SizedBox(height: 80),
                  Row(
