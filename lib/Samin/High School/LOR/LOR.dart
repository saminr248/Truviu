...
import '../../../widgets.dart';
import 'LOR_test_1.dart';

class LOR extends StatefulWidget {
  const LOR({Key? key}) : super(key: key);
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image: NetworkImage('https://scontent.xx.fbcdn.net/v/t1.15752-9/293273642_1445203689322034_4512893456373495696_n.png?_nc_cat=107&ccb=1-7&_nc_sid=aee45a&_nc_ohc=VqVLKhlgQA8AX9WM4W7&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AVJLxSmljJ_qKziWWh3GWpH5sBgmdAF8-tRLlLSjQpChuA&oe=6314E92C'),
                          ),
                        ),
                      ),
                      SizedBox(height: MediaQuery.of(context).size.height*0.02),
                      Text("How to Prove You're Really Awesome",
                        style: TextStyle(
          ...
          Row(
            children: [
              ...
              Material(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => LOR_test_1()));
                  },
                  child: Container(
