...
import 'package:truviu_bvp/Samin/Truviu/video_player_truviu.dart';
import 'package:truviu_bvp/Samin/University%20Admission/banks/best_bank/video_player_bankbonus.dart';
...
final Uri _url = Uri.parse('https://docs.google.com/forms/d/e/1FAIpQLSd8nC7PylhSL9ixkeLPCNVBAMd5OcEmv68v-XYSxFvMAMnuOQ/viewform');

class Truviu extends StatefulWidget {
  const Truviu({Key? key}) : super(key: key);

  @override
  State<Truviu> createState() => _TruviuState();
}
class _TruviuState extends State<Truviu> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image: CachedNetworkImageProvider('http://13.229.103.9:3000/images/image_1660337508857.png'),
                          ),
                        ),
                      ),
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = td[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => td[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => TruviuVideoScreen(),
      ),
    )
        : _launchUrl(),
    child: Container(
...
final List<TruviuData> td = [
  TruviuData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660337321237.png',
    title: 'Pedo Samin',
  ...
  TruviuData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660337345649.png',
    title: 'King Tajwar',
