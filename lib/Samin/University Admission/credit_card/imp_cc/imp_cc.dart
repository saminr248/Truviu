...
import 'package:truviu_bvp/Samin/University%20Admission/credit_card/credit_card.dart';
import 'package:truviu_bvp/Samin/University%20Admission/credit_card/imp_cc/cashback/cashback.dart';
import 'package:truviu_bvp/Samin/University%20Admission/credit_card/imp_cc/credit_score/credit_score.dart';
import 'package:truviu_bvp/admission/models.dart';
import 'package:truviu_bvp/widgets.dart';

class ImpCC extends StatefulWidget {
  const ImpCC({Key? key}) : super(key: key);

  @override
  State<ImpCC> createState() => _ImpCCState();
}
class _ImpCCState extends State<ImpCC> {
  @override
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text("The Plastic Card Is Essential for Life",
                        style: TextStyle(
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = impcc[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => impcc[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => Cashback(),
      ),
...
final List<ImpCCData> impcc = [
  ImpCCData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660233243980.png',
    title: 'Pedo Samin',
  ...
  ImpCCData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660233268859.png',
    title: 'King Tajwar',
