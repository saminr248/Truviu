...
import 'package:truviu_bvp/Samin/University%20Admission/credit_card/imp_cc/cashback/video_player_cashback.dart';
import 'package:truviu_bvp/Samin/University%20Admission/credit_card/imp_cc/cashback/video_player_maximize.dart';
...
class _CashbackState extends State<Cashback> {
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = cashd[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => cashd[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => CashbackCCVideoScreen(),
      ),
    )
        : Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => MaximizeCCVideoScreen(),
      ),
    ),
    child: Container(
...
final List<CashbackData> cashd = [
  CashbackData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660233461112.png',
    title: 'Pedo Samin',
  ...
  CashbackData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660233481468.png',
    title: 'King Tajwar',
