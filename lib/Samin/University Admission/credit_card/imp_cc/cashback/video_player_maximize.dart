...
class MaximizeCCVideoScreen extends StatefulWidget {
  const MaximizeCCVideoScreen({Key? key}) : super(key: key);

  @override
  State<MaximizeCCVideoScreen> createState() => _MaximizeCCVideoScreenState();
}

class _MaximizeCCVideoScreenState extends State<MaximizeCCVideoScreen> {
  @override
...
class MaximizeCCVideo extends StatefulWidget {
  const MaximizeCCVideo({Key? key}) : super(key: key);

  @override
  _MaximizeCCVideoState createState() => _MaximizeCCVideoState();
}

class _MaximizeCCVideoState extends State<MaximizeCCVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: maximizecc.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: maximizecc.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: maximizecc[index]['videoUrl'],
            size: size,
            name: maximizecc[index]['name'],
            caption: maximizecc[index]['caption'],
            profileImg: maximizecc[index]['profileImg'],
          );
        });
  }
}
...
List maximizecc = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660246777790.mp4",
    "name": "Samin Rahman",
    "caption": "",
