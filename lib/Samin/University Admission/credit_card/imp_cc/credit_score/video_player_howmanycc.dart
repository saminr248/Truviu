...
class HowManyCCVideoScreen extends StatefulWidget {
  const HowManyCCVideoScreen({Key? key}) : super(key: key);

  @override
  State<HowManyCCVideoScreen> createState() => _HowManyCCVideoScreenState();
}

class _HowManyCCVideoScreenState extends State<HowManyCCVideoScreen> {
  @override
...
class HowManyCCVideo extends StatefulWidget {
  const HowManyCCVideo({Key? key}) : super(key: key);

  @override
  _HowManyCCVideoState createState() => _HowManyCCVideoState();
}

class _HowManyCCVideoState extends State<HowManyCCVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: howmanycc.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: howmanycc.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: howmanycc[index]['videoUrl'],
            size: size,
            name: howmanycc[index]['name'],
            caption: howmanycc[index]['caption'],
            profileImg: howmanycc[index]['profileImg'],
          );
        });
  }
}
...
List howmanycc = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660247247146.mp4",
    "name": "Samin Rahman",
    "caption": "",
