...
class CCMaintainVideoScreen extends StatefulWidget {
  const CCMaintainVideoScreen({Key? key}) : super(key: key);

  @override
  State<CCMaintainVideoScreen> createState() => _CCMaintainVideoScreenState();
}

class _CCMaintainVideoScreenState extends State<CCMaintainVideoScreen> {
  @override
...
class CCMaintainVideo extends StatefulWidget {
  const CCMaintainVideo({Key? key}) : super(key: key);

  @override
  _CCMaintainVideoState createState() => _CCMaintainVideoState();
}

class _CCMaintainVideoState extends State<CCMaintainVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: ccmaintain.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: ccmaintain.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: ccmaintain[index]['videoUrl'],
            size: size,
            name: ccmaintain[index]['name'],
            caption: ccmaintain[index]['caption'],
            profileImg: ccmaintain[index]['profileImg'],
          );
        });
  }
}
...
List ccmaintain = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660247168181.mp4",
    "name": "Samin Rahman",
    "caption": "",
