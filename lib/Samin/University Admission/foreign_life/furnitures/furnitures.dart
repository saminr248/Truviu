...
import 'package:truviu_bvp/Samin/University%20Admission/foreign_life/furnitures/video_player_chair.dart';
import 'package:truviu_bvp/Samin/University%20Admission/foreign_life/furnitures/video_player_mattress.dart';
...
class _FurnituresState extends State<Furnitures> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image: CachedNetworkImageProvider('http://13.229.103.9:3000/images/image_1660237426589.png'),
                          ),
                        ),
                      ),
                      SizedBox(height: MediaQuery.of(context).size.height*0.02),
                      Text("Life's Necessities",
                        style: TextStyle(
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = fd[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => fd[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ChairVideoScreen(),
      ),
    )
        : Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => MattressVideoScreen(),
      ),
    ),
    child: Container(
...
final List<FurnituresData> fd = [
  FurnituresData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660231791536.png',
    title: 'King Tajwar',
  ...
  FurnituresData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660231757874.png',
    title: 'Pedo Samin',
