...
class ChairVideoScreen extends StatefulWidget {
  const ChairVideoScreen({Key? key}) : super(key: key);

  @override
  State<ChairVideoScreen> createState() => _ChairVideoScreenState();
}

class _ChairVideoScreenState extends State<ChairVideoScreen> {
  @override
...
class ChairVideo extends StatefulWidget {
  const ChairVideo({Key? key}) : super(key: key);

  @override
  _ChairVideoState createState() => _ChairVideoState();
}

class _ChairVideoState extends State<ChairVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: chair.length, vsync: this);
    Wakelock.enable();
  }
    ...
    return PageView.builder(
        ...
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: chair[index]['videoUrl'],
            size: size,
            name: chair[index]['name'],
            caption: chair[index]['caption'],
            profileImg: chair[index]['profileImg'],
          );
        });
  }
}
...
List chair = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660240156614.mp4",
    "name": "Samin Rahman",
    "caption": "",
