...
class HowSimVideoScreen extends StatefulWidget {
  const HowSimVideoScreen({Key? key}) : super(key: key);

  @override
  State<HowSimVideoScreen> createState() => _HowSimVideoScreenState();
}

class _HowSimVideoScreenState extends State<HowSimVideoScreen> {
  @override
...
class HowSimVideo extends StatefulWidget {
  const HowSimVideo({Key? key}) : super(key: key);

  @override
  _HowSimVideoState createState() => _HowSimVideoState();
}

class _HowSimVideoState extends State<HowSimVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: howsim.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: howsim.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: howsim[index]['videoUrl'],
            size: size,
            name: howsim[index]['name'],
            caption: howsim[index]['caption'],
            profileImg: howsim[index]['profileImg'],
          );
        });
  }
}
...
List howsim = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660245974599.mp4",
    "name": "Samin Rahman",
    "caption": "",
