...
class CoursesVideoScreen extends StatefulWidget {
  const CoursesVideoScreen({Key? key}) : super(key: key);

  @override
  State<CoursesVideoScreen> createState() => _CoursesVideoScreenState();
}

class _CoursesVideoScreenState extends State<CoursesVideoScreen> {
  @override
...
class CoursesVideo extends StatefulWidget {
  const CoursesVideo({Key? key}) : super(key: key);

  @override
  _CoursesVideoState createState() => _CoursesVideoState();
}

class _CoursesVideoState extends State<CoursesVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: courses.length, vsync: this);
    Wakelock.enable();
  }
    ...
    return PageView.builder(
        ...
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            ...
            caption: courses[index]['caption'],
            profileImg: courses[index]['profileImg'],
          );
        });
  }
}
...
List courses = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660239211372.mp4",
    "name": "Samin Rahman",
    "caption": "",
