...
class InsuranceVideoScreen extends StatefulWidget {
  const InsuranceVideoScreen({Key? key}) : super(key: key);

  @override
  State<InsuranceVideoScreen> createState() => _InsuranceVideoScreenState();
}

class _InsuranceVideoScreenState extends State<InsuranceVideoScreen> {
  @override
...
class InsuranceVideo extends StatefulWidget {
  const InsuranceVideo({Key? key}) : super(key: key);

  @override
  _InsuranceVideoState createState() => _InsuranceVideoState();
}

class _InsuranceVideoState extends State<InsuranceVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: insurance.length, vsync: this);
    Wakelock.enable();
  }
    ...
    return PageView.builder(
        ...
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: insurance[index]['videoUrl'],
            size: size,
            name: insurance[index]['name'],
            caption: insurance[index]['caption'],
            profileImg: insurance[index]['profileImg'],
          );
        });
  }
}
...
List insurance = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660245623385.mp4",
    "name": "Samin Rahman",
    "caption": "",
