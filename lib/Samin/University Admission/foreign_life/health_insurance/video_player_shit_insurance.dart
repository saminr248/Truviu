...
class ShitInsuranceVideoScreen extends StatefulWidget {
  const ShitInsuranceVideoScreen({Key? key}) : super(key: key);

  @override
  State<ShitInsuranceVideoScreen> createState() => _ShitInsuranceVideoScreenState();
}

class _ShitInsuranceVideoScreenState extends State<ShitInsuranceVideoScreen> {
  @override
...
class ShitInsuranceVideo extends StatefulWidget {
  const ShitInsuranceVideo({Key? key}) : super(key: key);

  @override
  _ShitInsuranceVideoState createState() => _ShitInsuranceVideoState();
}

class _ShitInsuranceVideoState extends State<ShitInsuranceVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: shitinsurance.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: shitinsurance.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: shitinsurance[index]['videoUrl'],
            size: size,
            name: shitinsurance[index]['name'],
            caption: shitinsurance[index]['caption'],
            profileImg: shitinsurance[index]['profileImg'],
          );
        });
  }
}
...
List shitinsurance = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660245875343.mp4",
    "name": "Samin Rahman",
    "caption": "",
