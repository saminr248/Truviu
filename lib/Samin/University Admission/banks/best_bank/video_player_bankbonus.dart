...
class BankBonusVideoScreen extends StatefulWidget {
  const BankBonusVideoScreen({Key? key}) : super(key: key);

  @override
  State<BankBonusVideoScreen> createState() => _BankBonusVideoScreenState();
}

class _BankBonusVideoScreenState extends State<BankBonusVideoScreen> {
  @override
...
class BankBonusVideo extends StatefulWidget {
  const BankBonusVideo({Key? key}) : super(key: key);

  @override
  _BankBonusVideoState createState() => _BankBonusVideoState();
}

class _BankBonusVideoState extends State<BankBonusVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: bankbonus.length, vsync: this);
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: bankbonus.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: bankbonus[index]['videoUrl'],
            size: size,
            name: bankbonus[index]['name'],
            caption: bankbonus[index]['caption'],
            profileImg: bankbonus[index]['profileImg'],
          );
        });
  }
}
...
List bankbonus = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660254446262.mp4",
    "name": "Samin Rahman",
    "caption": "",
