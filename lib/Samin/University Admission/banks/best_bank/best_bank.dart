...
class BestBank extends StatefulWidget {
  const BestBank({Key? key}) : super(key: key);

  @override
  State<BestBank> createState() => _BestBankState();
}
class _BestBankState extends State<BestBank> {
  @override
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = bb[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => bb[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BestBankVideoScreen(),
      ),
    )
        : Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BankBonusVideoScreen(),
      ),
    ),
    child: Container(
...
final List<BestBankData> bb = [
  BestBankData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660234571635.png',
    title: 'Pedo Samin',
  ...
  BestBankData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660234590204.png',
    title: 'King Tajwar',
