...
class ReportUniVideoScreen extends StatefulWidget {
  const ReportUniVideoScreen({Key? key}) : super(key: key);

  @override
  State<ReportUniVideoScreen> createState() => _ReportUniVideoScreenState();
}

class _ReportUniVideoScreenState extends State<ReportUniVideoScreen> {
  @override
...
class ReportUniVideo extends StatefulWidget {
  const ReportUniVideo({Key? key}) : super(key: key);

  @override
  _ReportUniVideoState createState() => _ReportUniVideoState();
}

class _ReportUniVideoState extends State<ReportUniVideo> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: reportuni.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: reportuni.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: reportuni[index]['videoUrl'],
            size: size,
            name: reportuni[index]['name'],
            caption: reportuni[index]['caption'],
            profileImg: reportuni[index]['profileImg'],
          );
        });
  }
}
...
List reportuni = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660247449591.mp4",
    "name": "Samin Rahman",
    "caption": "",
