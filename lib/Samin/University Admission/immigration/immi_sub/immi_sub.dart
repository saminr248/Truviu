...
class ImmiSub extends StatefulWidget {
  const ImmiSub({Key? key}) : super(key: key);

  @override
  State<ImmiSub> createState() => _ImmiSubState();
}
class _ImmiSubState extends State<ImmiSub> {
  @override
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text("Is It Scary or Is It Scary?",
                        style: TextStyle(
          ...
          Center(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = isub[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => isub[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => SizedBox(),
      ),
...
final List<ImmiSubData> isub = [
  ImmiSubData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660338492411.png',
    title: 'Pedo Samin',
  ...
  ImmiSubData(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660235300931.png',
    title: 'King Tajwar',
