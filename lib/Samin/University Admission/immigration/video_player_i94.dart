...
class I94VideoScreen extends StatefulWidget {
  const I94VideoScreen({Key? key}) : super(key: key);

  @override
  State<I94VideoScreen> createState() => _I94VideoScreenState();
}

class _I94VideoScreenState extends State<I94VideoScreen> {
  @override
...
class I94Video extends StatefulWidget {
  const I94Video({Key? key}) : super(key: key);

  @override
  _I94VideoState createState() => _I94VideoState();
}

class _I94VideoState extends State<I94Video> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(length: i94.length, vsync: this);
    Wakelock.enable();
  }
  ...
  Widget getBody() {
    ...
    return PageView.builder(
        itemCount: i94.length,
        itemBuilder: (context, index) {
          return VideoPlayerItem(
            videoUrl: i94[index]['videoUrl'],
            size: size,
            name: i94[index]['name'],
            caption: i94[index]['caption'],
            profileImg: i94[index]['profileImg'],
          );
        });
  }
}
...
List i94 = [
  {
    "videoUrl": "http://13.229.103.9:3000/videos/video_1660247601769.mp4",
    "name": "Samin Rahman",
    "caption": "",
