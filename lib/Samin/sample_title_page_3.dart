...
import 'package:truviu_bvp/Samin/High%20School/no_content.dart';
import 'package:truviu_bvp/admission/models.dart';

import '../widgets.dart';
import 'University Admission/i_am_in_university_test_2.dart';
import 'sample_title_page_2.dart';
import 'sample_title_page_5.dart';

class TestTitle3 extends StatefulWidget {
  const TestTitle3({Key? key}) : super(key: key);
...
class _TestTitle3State extends State<TestTitle3> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image: CachedNetworkImageProvider('http://13.229.103.9:3000/images/image_1660238737896.png'),
                          ),
                        ),
                      ),
          ...
          // ),
            ...
            child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex){
                final urlImage = tt3d[index].imageUrl;
  ...
  Widget buildImage(String urlImage, int index) => GestureDetector(
    onTap: () => tt3d[index].title == 'Pedo Samin' ? Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => NoContent(),
      ),
...
final List<TestTile3Data> tt3d = [
  TestTile3Data(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660229240507.png',
    title: 'Pedo Samin',
  ...
  TestTile3Data(
    imageUrl: 'http://13.229.103.9:3000/images/image_1660229270179.png',
    title: 'King Tajwar',
